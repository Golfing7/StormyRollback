...
public class MessageData extends ConfigFile {
    ...
    public void setMessages() {      
		...
		killer = convertColourCodes((String) getDefaultValue("messages.killer", "&6Killer: &f%KILLER%"));
    ...
    public String killer(String killer1){ return killer.replaceAll("%KILLER%", killer1);}
